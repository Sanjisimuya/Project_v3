...
export function BottomNav({ activeTab, onTabChange, onAddExpense }: Props) {
  const tabs = [
  ...
  return (
    ...
    >
      ...
      {/* Nav Bar */}
      <div className="bg-white border-t border-gray-100 flex items-stretch" style={{ paddingBottom: "env(safe-area-inset-bottom, 0px)" }}>
        {tabs.map((tab, idx) => {
          const Icon = tab.icon;
